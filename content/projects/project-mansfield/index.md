...
{{< figure
    ...
    caption="Login Screen to our Sports Betting App"
>}}

## Features

* Secure Google Account Authorization for Login.
* Live Sports Game bets for the NFL, NCAAF, NBA, NCAAB, and NHL leagues.
* Betting Options for Spread, Moneyline, and Over/Under for games upcoming within 24 hours.
